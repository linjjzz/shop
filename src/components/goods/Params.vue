...
export default {
  ...
  methods: {
    ...
    addParams() {
      this.$refs.addFormRef.validate((valid) => {
        ...
        addAttributes(
          ...
          console.log(this.cateId, this.addForm)
          console.log(res)
    ...
    showEditDialog(attr_id) {
      //查询当前参数的信息
      getAttrName(this.cateId, attr_id, this.activeName).then((res) => {
        if (res.meta.status !== 200) {
    ...
    showInput(row) {
      ...
      //让文本框自动获取焦点
      //$nextTick方法就是当页面上元素被重新渲染之后，才会指定回调函数中的代码
      this.$nextTick(() => {
